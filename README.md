...
In this workshop we will deploy twoo microservices as containers running in a Kubernetes cluster. Traffic will reach the containers through aa Kubernnete Ingress with Nginx routing traffiic to the two different services based on the path of the request.
